...
- **Day Log** — one unified log: "How was today?" (Good / So-so / Rough), an optional 1–10 pain level, shared factor chips ("what did you do"), and a note. Good days get captured too, so it surfaces "what works on your good days," and Past Entries is filterable by day type.
